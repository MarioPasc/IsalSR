#!/usr/bin/env bash
# SLURM compute worker: Distance-1 Neighborhood Analysis (Experiment 2)
# Fast illustrative experiment (~30 seconds).
set -euo pipefail

echo "=== Experiment 2: Neighborhood - SLURM Worker ==="
...
OUT_DIR="${RESULTS_DIR}/exp2_neighborhood"
mkdir -p "$OUT_DIR"
