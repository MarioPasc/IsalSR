...
Uses the Population class for tournament selection, crossover, mutation,
with mandatory canonicalization after every modification.

Usage:
    python experiments/scripts/run_gp.py \
        --pop-size 50 --n-generations 20 --seed 42 \
        --output results/gp_search.csv
"""
...
DEFAULT_OUTPUT = "/media/mpascual/Sandisk2TB/research/isalsr/results/gp_search.csv"
